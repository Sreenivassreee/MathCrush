...
class FirePref {
  static Future<String> initialFirebasePrefSave(user) async {
    ...
    preferences.setInt("Completed_level", user.current_level);
    preferences.setInt("Score", user.current_score);
    preferences.setString("pin", user.pin.toString());
    preferences.setString("about", user.about);
    _mess = "Sucess";
    return _mess;
  }
